...
values  = { 'impact':  '1' , 'urgency':  '1' , 'priority':  '1' , 'category':  'network' , 'location':  'San Diego' , 'user':  'Aaron Aaronson' , 'assignment_group':  'Technical Support' , 'assigned_to':  'David Loo' , 'short_description':  'An incident created using python, SOAPpy, and web services.' , 'comments':  'This a test making an incident with python.\n Isn \' t life wonderful?' }
